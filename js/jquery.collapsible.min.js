...
!(function (e, s) {
    e.fn.collapsible = function (s) {
        var n = { accordion: !1, accordionUpSpeed: 400, accordionDownSpeed: 400, collapseSpeed: 400, contentOpen: null, arrowRclass: "arrow-r", arrowDclass: "arrow-d", animate: !0 },
            c = e.extend(n, s);
        return this.each(function () {
            ...
            var s = e(this).children(":even"),
                ...
                r = "accordion-active";
            if ((e(this).children(":nth-child(even)").css("display", "none"), !0 === c.accordion))
                null !== c.contentOpen &&
                    (e(s[c.contentOpen])
